  ...
  return (
    <div className="w-full h-full flex flex-col justify-center items-center text-center p-8">
      ...
      <div className={`transition-all duration-1000 ease-out absolute flex flex-col items-center justify-center w-full max-w-6xl px-4 ${getSceneOpacity(3)} ${activeScene === 3 ? "pointer-events-auto" : ""}`}>
        ...
        <a href="/property#portfolio" className="inline-flex items-center gap-3 px-8 py-3 bg-[#b58d3c] hover:bg-[#cbad67] text-[#1c1c1c] uppercase tracking-[0.2em] text-xs sm:text-sm font-bold transition-all duration-300 shadow-[0_4px_20px_rgba(0,0,0,0.5)] hover:shadow-[0_0_30px_rgba(181,141,60,0.6)] rounded-full group">
