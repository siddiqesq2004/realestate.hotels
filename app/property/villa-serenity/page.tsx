...
export default function VillaSerenityPage() {
  return (
    <main className="bg-charcoal-900 min-h-screen text-ivory-100 overflow-x-hidden">
      ...
      <section className="relative h-[70vh] w-full flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-6 mt-20">
          <FadeIn delay={0.2}>
            <p className="text-bronze-400 uppercase tracking-[0.3em] text-sm mb-6 font-medium">Tuscany, Italy</p>
          </FadeIn>
          <FadeIn delay={0.4}>
            <h1 className="text-5xl md:text-7xl font-serif tracking-wide mb-6">Villa Serenity Resort & Residences</h1>
          </FadeIn>
        </div>
      </section>
      ...
      <section className="py-24 px-6 md:px-12 max-w-4xl mx-auto text-center">
        <FadeIn direction="up">
          <p className="text-ivory-300 font-sans leading-relaxed text-xl font-light mb-12">
            A breathtaking Italian masterpiece nestled in the rolling hills of Tuscany. Villa Serenity offers an authentic escape with its own private vineyard, centuries-old olive groves, and panoramic views of the Mediterranean coastline. Now offering limited availability for private residence ownership and fractional investment opportunities.
          </p>
